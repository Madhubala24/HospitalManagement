...
function HomePage() {
  ...
  // const loggedInAdmin = isLoggedIn === "adminLog";
  ...
  return (
    ...
    <strong><h1>Welcome to the Hospital Management System</h1></strong>
      ...
      <div className="buttons">
        ...
        {loggedInDoctor && (
          <Link to="/appointment-details">
            <button className="container viewing">Appointment Details</button>
          </Link>
        )}
        ...
        {loggedInPatient && (
          <Link to="/appointment-details">
           <strong> <button className="container viewing">Appointment Details</button> </strong>
          </Link>
        )}
        ...
        {loggedInAdmin && (
          ...
          <Link to="/doctor-management">
           ...
           {loggedInAdmin && (
          <Link to="/appointment-management">
            <button className="container appointment">appointment-management</button>
          </Link>
